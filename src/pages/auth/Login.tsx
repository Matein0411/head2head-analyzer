...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 flex flex-col justify-center items-center px-4 py-6">
      <div className="flex flex-col items-center w-full">
        ...
        <div className="bg-white/95 rounded-2xl shadow-2xl px-4 sm:px-8 py-6 sm:py-10 w-full max-w-md flex flex-col items-center gap-4 sm:gap-6 border border-gray-200">
          <h1 className="font-bold text-xl sm:text-2xl text-center text-gray-900 mb-2">Iniciar sesión</h1>
          <form className="flex flex-col gap-3 w-full">
            ...
            <input
              ...
              className="px-3 py-3 sm:py-2 rounded-xl border border-gray-300 focus:outline-none w-full text-base text-gray-900 bg-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            <button className="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 text-white hover:from-blue-700 hover:to-blue-500 rounded-lg py-3 sm:py-2 font-semibold shadow transition-all duration-200 text-base">Login</button>
          </form>
          <div className="flex flex-col sm:flex-row justify-between w-full gap-2 sm:gap-0">
            <Link to="/SignUp" className="font-semibold text-sm text-[#1f50aa] hover:text-[#173b8a] hover:underline transition-colors text-center sm:text-left">
              New? Create an account
            </Link>
            <Link to="/ForgetPassword" className="font-semibold text-sm text-[#1f50aa] hover:text-[#173b8a] hover:underline transition-colors text-center sm:text-right">
              Forgot password?
            </Link>
          </div>
